...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
							...
							<div class="controls">
								<div class="input-prepend">
									<span class="add-on"><i class="icon-user"></i> </span> <input
										id="inputusername" name="id" placeholder="input user name" type="text" onblur="check();"onfocus="checkagain();" autofocus>
								</div>
							</div>
						</div>
						<div class="control-group">
			...
			<div class="row-fluid">
				<div class="span12" style="text-align:center;margin-top:30px;margin-bottom:30px;">
					<h3>
						Powered by     <a href="#" data-toggle="tooltip" title="http://www.nenew.net">nenew</a>
					</h3>
					<div class="row-fluid">
						<div class="span2  offset2">
							<h3 style="margin-top:35px;">技术支持：</h3>
						</div>
						<div class="span1">
