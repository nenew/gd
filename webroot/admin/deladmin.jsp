...
<title>管理员管理——毕业设计在线管理系统</title>
<!-- Bootstrap -->
<link href="css/bootstrap.css" rel="stylesheet" media="screen">
<link href="css/deladmin.css" rel="stylesheet">
...
<body>
 ...
 %><b class="caret"> </b> </a>
						...
						<ul class="nav nav-pills">
							...
							<li class="dropdown  dropdowntrasparent active"><a href="#"
								...
								<ul class="dropdown-menu">
									...
									<li class="active"><a href="deladmin.jsp">管理员管理</a></li>
								</ul></li>
							<li class="dropdown  dropdowntrasparent"><a href="#"
		...
		<div class="container-fluid containerfix">
			<div class="row-fluid">
				<div class="span12 contentitle">管理员管理</div>
			</div>
			<div class="row-fluid">
	...
	<script>
		$(document).ready(function() {
			...
			$.post('deladmin', data, function(data, textStatus, jqXHR) {
				$('#contentbody').html(data);
			});
			$.post('countadmin', data, function(data, textStatus, jqXHR) {
				$('#pager').html(data);
